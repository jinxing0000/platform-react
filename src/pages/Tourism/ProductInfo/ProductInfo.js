...
class ProductInfo extends PureComponent {
    ...
    return (
      <Form onSubmit={this.handleSearch} layout="inline">
        <Row gutter={{ md: 8, lg: 24, xl: 48 }}>
          <Col md={6} sm={24}>
            <FormItem label="产品名称">
              {getFieldDecorator('productName', { initialValue: params.name })(
  ...
  goToAddOrUpdatePage(id) {
    this.props.dispatch(
      routerRedux.push({
        pathname: '/tourism/productInfo/addOrUpdate',
        query: {
          id: id,
        },
      })
    ...
    const columns = [
      ...
      },
      {
        ...
        render: (val, item, index) => (
          <span>
            {item.tripDays}天{item.tripNightNum}晚
          </span>
        ),
      },
      // {
        ...
        render: (text, record) => (
          <Fragment>
            ...
            {currentUser.permsSet &&
              currentUser.permsSet.includes('tourism:productInfo:update') && (
